...
create table persona (id int8 not null, version int4 not null, cabeza bytea, descripcion_direccion varchar(255) not null, direccion varchar(255) not null, documento varchar(255) not null, factor bytea not null, grupo_sanguineo bytea not null, nombre varchar(255) not null, numero_partida int4 not null, parentesco bytea, sexo varchar(1) not null, primary key (id));
